...
page_soup = soup(driver.page_source, 'html5lib')
time.sleep(15)
All_lst = page_soup.findAll('span', attrs={'class': 'mn-connection-card__name t-16 t-black t-bold'})
i = 1
time.sleep(5)
for req in All_lst:
    driver.find_element_by_xpath("/html/body/div[6]/div[4]/div[3]/div/div/div/div/div/div/div/div/section/ul/li[" + str(i) + "]/div/div[1]/a").click()
    time.sleep(5)
    ...
    #driver.find_elements_by_class_name('t-16 t-bold')[1].click()
    time.sleep(5)
    page_soup = soup(driver.page_source, 'lxml')
    time.sleep(10)
    email_container = page_soup.find('section', attrs={'class': 'pv-contact-info__contact-type ci-email'})
